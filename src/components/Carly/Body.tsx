                ...
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 261.93 245.906">
                    <g id="Group 2">
                        <g filter="url(#filter0_f_1_476)" id="Ellipse 6">
                            <circle cx="103.133" cy="103.133" fill="var(--fill-0, #4E78FF)" fillOpacity={ theme === "light" ? "0.3" : "0.5"} r="53.1332" />
                        </g>
                        <g filter="url(#filter1_f_1_476)" id="Ellipse 8">
                            <circle cx="156.266" cy="152.893" fill="var(--fill-0, #FF7DF2)" fillOpacity={ theme === "light" ? "0.3" : "0.5"} r="43.0126" />
                        </g>
                        <g filter="url(#filter2_f_1_476)" id="Ellipse 9">
                            <circle cx="112.41" cy="146.989" fill="var(--fill-0, #638CF4)" fillOpacity={ theme === "light" ? "0.3" : "0.5"} r="43.856" />
                        </g>
                        <g filter="url(#filter3_f_1_476)" id="Ellipse 7">
                            <circle cx="171.447" cy="103.133" fill="var(--fill-0, #7E41F8)" fillOpacity={ theme === "light" ? "0.3" : "0.5"} r="40.4825" />
                        </g>
                    </g>
                    <defs>
